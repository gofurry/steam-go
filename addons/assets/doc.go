...
// discovers official Store item asset URLs, requests Storefront screenshot/movie/background
// URLs, and provides small helpers for verifying, reading, and downloading those resources.
//
